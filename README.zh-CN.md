...
在学术圈里，prompt 工程正在逐渐成为一种“隐性资源”。

少数团队已经沉淀出成熟的模板、提示词和工作流，能够更高效地使用 AI；但更多学生、研究者和青年学者，仍然需要从零摸索：不知道怎么提问，不知道怎么拆解任务，也不知道如何把 agent 真正用于论文写作。

与此同时，AI 和 agent 的快速发展，已经能够显著提升学术研究中许多环节的效率。但对于很多学术人员来说，这些能力依然有门槛，难以真正上手。

我们创建 **PaperSkills**，就是希望把这些原本分散、隐性的经验，整理成一组更清晰、更可复用、更容易上手的 skills，让更多研究者都能更自然地把 AI 接入真实研究流程。
...
**把学术研究中那些重复、耗时、但又高度结构化的环节，沉淀为 agent 可以直接调用的技能。**
