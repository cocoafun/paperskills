...
- using-paperskills: Use when starting any research-oriented conversation to diagnose the current PaperSkills stage, decide whether the task needs a multi-stage workflow, and route the agent before answering directly. (file: /Users/young/workspace/paper/paperskills/skills/using-paperskills/SKILL.md)
