...
TESTS=(
  ...
  "full-paper-from-topic|using-paperskills,research-scoping,literature-review,paper-drafting,manuscript-finalization|$PROMPTS_DIR/full-paper-from-topic.txt"
